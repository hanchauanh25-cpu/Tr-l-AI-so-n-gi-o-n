...
<div class="main-header">
    ...
    <p>Tác giả: Nông Thị Huệ - Trường Tiểu học Đông An - ĐT: 091 763 1189</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nông Thị Huệ - Trường Tiểu học Đông An - ĐT: 097 1986 343</div>", unsafe_allow_html=True)
